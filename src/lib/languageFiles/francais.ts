...
const languageFrancais: LanguageData = {
    titles:{
        ...
        events: "Événements",
        featuredArticles: "Articles vedette",
        featuredPicturesGallery: "Galerie d’images vedette",
        gallery: "Galerie",
        home: "Accueil",
    ...
    message: {
        ...
        error: {
            ...
            passwordTooLong: "Mot de passe trop long! (Max 64 caractèress)",
            ...
            DescriptionTooLong: "Description trop long! (Max 2000 Caractères)",
